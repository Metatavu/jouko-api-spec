...
export const DevicesApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {Date} fromTime The start of the time period that we measure the consumption in, inclusive
         * @param {Date} toTime The end of the time period that we measure the consumption in, exclusive
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getPowerConsumption(userId: number, deviceId: number, fromTime: Date, toTime: Date, options: any = {}): FetchArgs {
...
export const DevicesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getPowerConsumption(userId: number, deviceId: number, fromTime: Date, toTime: Date, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<DevicePowerConsumption> {
...
export const DevicesApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        getPowerConsumption(userId: number, deviceId: number, fromTime: Date, toTime: Date, options?: any) {
...
export class DevicesApi extends BaseAPI {
     ...
     * @memberof DevicesApi
     */
    public getPowerConsumption(userId: number, deviceId: number, fromTime: Date, toTime: Date, options?: any) {
...
export const InterruptionsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {Date} fromTime List interruptions that start after this point of time, inclusive
         * @param {Date} toTime List interruptions that end before this point of time, exclusive
         * @param {number} [deviceId] The device id whose interruptions we list, list all if omitted
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listInterruptions(userId: number, fromTime: Date, toTime: Date, deviceId?: number, options: any = {}): FetchArgs {
            // verify required parameter 'userId' is not null or undefined
            if (userId === null || userId === undefined) {
...
export const InterruptionsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        listInterruptions(userId: number, fromTime: Date, toTime: Date, deviceId?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<Interruption>> {
...
export const InterruptionsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        listInterruptions(userId: number, fromTime: Date, toTime: Date, deviceId?: number, options?: any) {
...
export class InterruptionsApi extends BaseAPI {
     ...
     */
    public listInterruptions(userId: number, fromTime: Date, toTime: Date, deviceId?: number, options?: any) {
